...
const Hammer = createLucideIcon("hammer", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-cream font-sans text-charcoal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "header",
      {
        className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-cream shadow-card py-2" : "bg-cream/90 backdrop-blur-sm py-3"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-6xl mx-auto px-6 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-xl font-bold text-charcoal tracking-wide", children: "DESIGLOW" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "hidden md:flex items-center gap-8 font-sans text-sm font-semibold uppercase tracking-widest", children: [
              ...
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `block w-6 h-0.5 bg-charcoal transition-all ${mobileMenuOpen ? "rotate-45 translate-y-2" : ""}`
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      className: `block w-6 h-0.5 bg-charcoal transition-all ${mobileMenuOpen ? "opacity-0" : ""}`
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
          ...
          mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-cream border-t border-cream-dark px-6 py-4 flex flex-col gap-4 font-sans text-sm font-semibold uppercase tracking-widest", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        style: {
          backgroundImage: "url('/assets/generated/hero-decor.dim_1200x700.jpg')",
          backgroundSize: "cover",
          backgroundPosition: "center"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-charcoal/75 via-charcoal/60 to-charcoal/80" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center gap-6 max-w-3xl fade-in", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: "/assets/uploads/IMG-20260130-WA0262-3-1.jpg",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-serif text-4xl md:text-6xl lg:text-7xl font-bold text-cream leading-tight", children: [
              "Where Indian Tradition",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              "Meets Modern Living"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/80 text-lg md:text-xl max-w-xl leading-relaxed", children: "Affordable, stylish home decor that brings the soul of India into every corner of your home." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest", children: "Scroll" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-6 h-6" })
              ]
            }
          )
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 bg-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatedSection, { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold text-sm font-semibold uppercase tracking-widest mb-3", children: "Our Promise" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-4xl md:text-5xl font-bold text-charcoal", children: "Why Choose DESIGLOW?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-4 w-20 h-1 bg-gold rounded-full" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-8 h-8 text-gold" }),
        ...
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-8 h-8 text-gold" }),
          title: "Modern Aesthetics",
          desc: "Clean, contemporary designs that seamlessly blend into modern homes while celebrating our cultural roots.",
          delay: 150
        },
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-8 h-8 text-gold" }),
          title: "Affordable Luxury",
          desc: "Premium craftsmanship and quality materials — without the premium price tag. Beautiful decor for every home.",
          delay: 300
        }
      ].map(({ icon, title, desc, delay }) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-8 shadow-card hover:shadow-gold transition-shadow border border-cream-dark flex flex-col gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-xl bg-cream-dark flex items-center justify-center", children: icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-xl font-bold text-charcoal", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-charcoal-soft leading-relaxed text-sm", children: desc })
      ] }) }, title)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "features", className: "py-24 bg-cream-dark", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatedSection, { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold text-sm font-semibold uppercase tracking-widest mb-3", children: "Handpicked & Handcrafted" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-4xl md:text-5xl font-bold text-charcoal", children: "Our Collection" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-4 w-20 h-1 bg-gold rounded-full" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: 0, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-2xl md:text-3xl font-bold text-charcoal", children: "Bringing India's Artistic Soul Into Your Home" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-charcoal-soft leading-relaxed", children: "Each piece in our collection is thoughtfully curated, blending traditional Indian artistry with the needs of modern living. From entryways to living rooms, we have something for every space." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4 mt-2", children: [
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Hammer, { className: "w-5 h-5 text-gold" }),
              text: "Handcrafted home accents"
            },
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-5 h-5 text-gold" }),
              text: "Traditional Indian motifs reimagined"
            },
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-5 h-5 text-gold" }),
              text: "Eco-friendly materials"
            },
            {
              icon: /* @__PURE__ */ jsxRuntimeExports.jsx(House, { className: "w-5 h-5 text-gold" }),
              text: "Curated for modern Indian homes"
            }
          ].map(({ icon, text }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-lg bg-cream flex items-center justify-center flex-shrink-0 shadow-xs", children: icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-charcoal font-medium", children: text })
          ] }, text)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative py-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "relative w-full",
        style: {
          backgroundImage: "url('/assets/generated/features-grid.dim_900x500.jpg')",
          backgroundSize: "cover",
          backgroundPosition: "center",
          minHeight: "380px"
        },
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col items-center justify-center h-full py-24 px-6 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatedSection, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold text-sm font-semibold uppercase tracking-widest mb-3", children: "Our Story in Numbers" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl md:text-5xl font-bold text-cream mb-12", children: "Crafting Homes, Creating Memories" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-10 max-w-3xl mx-auto", children: [
              { stat: "100+", label: "Unique Products", delay: 0 },
              { stat: "★★★★★", label: "Happy Customers", delay: 150 },
              { stat: "∞", label: "Artisan Inspired", delay: 300 }
            ].map(({ stat, label, delay }) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-4xl md:text-5xl font-bold text-gold", children: stat }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-cream/80 text-sm uppercase tracking-widest font-semibold", children: label })
            ] }) }, label)) })
          ] })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-cream", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatedSection, { className: "text-center mb-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold text-sm font-semibold uppercase tracking-widest mb-3", children: "The People" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-4xl md:text-5xl font-bold text-charcoal", children: "The Minds Behind DESIGLOW" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto mt-4 w-20 h-1 bg-gold rounded-full" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto", children: [
      ...
      ].map(({ name, initials, delay }) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedSection, { delay, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-8 shadow-card border border-cream-dark flex flex-col items-center gap-4 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-lg font-bold text-charcoal", children: name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold text-sm font-semibold uppercase tracking-widest mt-1", children: "Co-Founder" })
        ] })
      ] }) }, name)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimatedSection, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold text-sm font-semibold uppercase tracking-widest mb-3", children: "Reach Out" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-4xl md:text-5xl font-bold text-cream mb-4", children: "Get in Touch" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/70 text-lg leading-relaxed mb-10", children: "Interested in our collection? Have a custom request? We'd love to hear from you." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-5 justify-center mb-10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 text-cream/50 text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tracking-widest font-semibold", children: "9687380038" })
          ] })
        ] }) })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-charcoal py-10 border-t border-charcoal-soft", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif font-bold text-cream text-lg tracking-wide", children: "DESIGLOW" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-cream/50 text-xs", children: "Where Indian Tradition Meets Modern Living" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-cream/40 text-sm text-center", children: [
        "© ",
        year,
        " DESIGLOW. Built with ",
